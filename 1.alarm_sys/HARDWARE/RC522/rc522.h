...
/******************************************
*	感谢来自CSDN博主的 RFID-RC522模块驱动源码；
*	地址： https://liefyuan.blog.csdn.net/article/details/80437095
**************************************************/
...
//
#define 	MI_OK                 (0)			// 寻卡成功；
#define 	MI_NOTAGERR           (1)			// 未知；未知情况！
#define 	MI_ERR                (2)			// 寻卡失败；
...
/***********************RC522 函数宏定义(这是函数原型！函数定义是.c同函数声明；)**********************/
...
/*** 自定义函数 ***/
int RC522_IcCard_Scan(void);					// IC卡扫描函数；
